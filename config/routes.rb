ActionController::Routing::Routes.draw do |map|
  ...
  # Keep in mind you can assign values other than :controller and :action
    map.connect 'auditorium/list/:year/:month/', :controller=>"auditorium", :action=>"query_by_month",\
    :defaults=>{:year=>Time.now.year, :month=>Time.now.month+1}

    map.connect 'auditorium/reserve/:date/', :controller=>"auditorium", :action=>"reserve"
